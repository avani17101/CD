...
def load_dataset(name,norm=True):
...
val_dataset2 = load_dataset("val_texture")

test_dataset = load_dataset("test")
test_dataset_random = load_dataset("test_random",norm=False)
test_dataset_texture = load_dataset("test_texture",norm=False)
test_dataset_colorhard = load_dataset("test_pixelrand",norm=False) #handomised pixel-wise colors
...
val_loader_tex = utils.DataLoader(val_dataset2,
    batch_size=args.test_batch_size, shuffle=True, **kwargs) 

test_loader = utils.DataLoader(test_dataset,
        batch_size=args.test_batch_size, shuffle=True, **kwargs) 

test_loader_r = utils.DataLoader(test_dataset_random,
        batch_size=args.test_batch_size, shuffle=True, **kwargs) 

test_loader_t = utils.DataLoader(test_dataset_texture,
        batch_size=args.test_batch_size, shuffle=True, **kwargs) 

test_loader_ch = utils.DataLoader(test_dataset_colorhard,
        batch_size=args.test_batch_size, shuffle=True, **kwargs) 
...
if args.mode == 'test':
    import csv
    fields = ['name', 'color_val_acc','tex_val_acc','acc','acc_r','acc_t','acc_ch']
    rows = []
    ...
    # name = "pairs_vals8num_imgs150lr0.39regularizer_rate0.07wtcav19.92batch_size32per_proto_mean_wt0.28use_proto1use_cdepcolor1use_precalc_proto1update_proto0train_from_scratch1use_knn_proto1class_wise_training0"
    # for name in sorted(glob.glob('/ssd_scratch/cvit/avani.gupta/*50*'+name+'*'))
    # for name in glob.glob('/home/avani.gupta/*color*.pt'): #glob.glob("/home/avani.gupta/acc49*tex*"):#['/home/avani.gupta/tcav_pt/methodvanillatex.pt']:#['/home/avani.gupta/acc50.93best0pairs_vals8num_imgs150lr0.39regularizer_rate0.07wtcav19.92batch_size32per_proto_mean_wt0.28use_proto1use_cdepcolor1use_precalc_proto1update_proto0train_from_scratch1use_knn_proto1class_wise_training0final_run','/home/avani.gupta/acc50.99best0pairs_vals8num_imgs150lr0.39regularizer_rate0.07wtcav19.92batch_size32per_proto_mean_wt0.28use_proto1use_cdepcolor1use_precalc_proto1update_proto0train_from_scratch1use_knn_proto1class_wise_training0final_run']:
    # for name in ['/home/avani.gupta/tcav_pt/method0color.pt','/home/avani.gupta/tcav_pt/method1color.pt','/home/avani.gupta/tcav_pt/method2color.pt','/home/avani.gupta/tcav_pt/method0color_tex.pt','/home/avani.gupta/tcav_pt/method1color_tex.pt','/home/avani.gupta/tcav_pt/method2color_tex.pt','/home/avani.gupta/tcav_pt/methodvanilla.pt','/home/avani.gupta/tcav_pt/best_cpk/acc62.2best_val_acc59.6highest_epoch0iter4facesfacesp8nimg100lr0.01rr0.3wtcav5bs44pwt0.3upr1cd1precalc1up1scratch1uknn1cwt0s42corr','/home/avani.gupta/tcav_pt/best_cpk/acc61.6best_val_acc60.1highest_epoch0iter4facesfacesp8nimg100lr0.01rr0.3wtcav5bs44pwt0.3upr1cd1precalc1up1scratch1uknn1cwt0s42corr']: #glob.glob("/home/avani.gupta/tcav_pt/dep/models/ColorMNIST_test/*.pkl"): #['/home/avani.gupta/tcav_pt/cdepcolor.pt']:
    for name in ['/home/avani.gupta/acc49.71best_val_acc56.53highest_epoch0iter56texturemnisttmnistp8nimg100lr0.01rr0.3wtcav5bs44pwt0.3upr1cd1precalc1up1scratch1uknn1cwt0s42corr']: #glob.glob('/home/avani.gupta/tcav_pt/*color*.pt'):    
    # for name in glob.glob('/ssd_scratch/cvit/avani.gupta/best_tex/*'):
        try:
            # for i in range(0,50):
            ...
            val_acc2 = test(model, device, val_loader_tex)

            acc = test(model, device, test_loader)
            acc_r = test(model, device, test_loader_r)
            acc_t = test(model, device, test_loader_t)
            acc_ch = test(model, device, test_loader_ch)



            # acc_lis.append(acc)
            print(name,val_acc,val_acc2, acc,acc_r, acc_t,acc_ch)
            rows.append([name,val_acc,val_acc2, acc,acc_r, acc_t,acc_ch])
        except Exception as e:
            print(e, name)
            # print(name,val_acc, acc,acc_r, acc_t,acc_ch)
        
        #     # os.rename(name, name.replace('checkpoints','test_checkpoints'))
        
    import time
    # timestr = time.strftime("%Y%m%d-%H%M%S")
    with open('baselines_tex_final_oursbest.csv', 'w') as csvfile: 
