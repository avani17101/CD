...
train_x_tensor = torch.Tensor(np.load(oj("../../data/", "decoyX.npy")))
train_y_tensor = torch.Tensor(np.load(oj("../../data/", "decoyy.npy"))).type(torch.int64)
...
test_x_tensor = torch.Tensor(np.load(oj("../../data/", "decoyXt.npy")))
test_y_tensor = torch.Tensor(np.load(oj("../../data/", "decoyyt.npy"))).type(torch.int64)
