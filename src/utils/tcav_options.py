...
class TCAVOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--model_type',default='colormnist',type=str)
        self.parser.add_argument('--dset',default='mnist',type=str)
        self.parser.add_argument('--cav_train_freq', type=float, default=0, help='# %iterations to use cav loss upon')
        self.parser.add_argument('--cav_train_freq_ep', type=int, default=100, help='# epochs to retrain cav vector')
        ...
        self.parser.add_argument("--use_nn_cav",default=True, type=int, help='lr or nn')
        ...
        self.parser.add_argument("--wtcav",default=20, type=float)
        ...
        self.parser.add_argument("--train_from_scratch", default=1, type=int,help="whether to train from scratch or not")
        self.parser.add_argument("--batch_size", default=44, type=int,help="batch size")
        ...
        self.parser.add_argument("--cav_update_freq", default=150, type=int, help="cav updates iters")
        self.parser.add_argument("--set_to_ep_level", default=0, type=int, help="update after each epoch")
        ...
        self.parser.add_argument('--pairs_vals', type=str, default="8", help="which multiple pairs")
        ...
        self.parser.add_argument('--update_cavs', type=int, default=0, help='whther to update cavs or use  the same one as init')
        ...
        self.parser.add_argument('--freeze_bef_layers', type=int, default=1, help='whther to load best finetuned model')
        self.parser.add_argument('--cdep_grad_method', type=int, default=1, help='grad method cdep')
        ...
        self.parser.add_argument("--lr", type=float, default=1e-2, help="Outer learning rate of model")
